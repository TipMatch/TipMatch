...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // 1. 初始化介绍视频控件 (Introduction Video)
  ...
  // 3. 新增：初始化简单任务视频控件 (Generalization to Simpler Tasks)
  // 这里的 ID 必须与你 HTML 中定义的 simple- 开头的 ID 一致
  new CustomVideoControls(
    'simple-video-element',
    '.custom-video-controls',
    'simple-play-pause-btn',
    'simple-progress-bar',
